...
function main() {
  ...
  function drawScene(clock) {
    ...
    var spread = 170;
    for (var yy = -1; yy <= 1; ++yy) { // -1,0,1
      for (var xx = -2; xx <= 2; ++xx) { // -2,-1,0,1,2
        ...
        // compute a clipspace position 计算剪辑空间位置
        ...
        // convert from clipspace to pixels 从裁剪空间转换到像素值
...
// const projectMatrix: Matrix = this.world.scene.activeCamera.getProjectionMatrix().clone().invert();
// const a = Vector3.TransformCoordinates(new Vector3(8, 1, 0), projectMatrix);
// // [8, 1, 0, 1];
// console.log('this.world.scene.getProjectionMatrix()', projectMatrix)
// console.log(a);