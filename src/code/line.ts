...
export function main() {
  ...
  var u_ModelMatrix = gl.getUniformLocation(gl.program!, 'u_ModelMatrix') as WebGLUniformLocation;
  if (!u_ModelMatrix) {
...
function draw(gl: CustomWebGLRenderingContext, n: number, currentAngle: number, modelMatrix: Matrix4, u_ModelMatrix: WebGLUniformLocation) {
